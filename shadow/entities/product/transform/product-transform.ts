...
import type { ShadowProduct, ShadowProductRow } from '@/shadow/entities/product/model/product';
import { shadowProductRowSchema, shadowProductSchema } from '@/shadow/entities/product/schema/product-schema';
