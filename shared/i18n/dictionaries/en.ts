...
export const enDictionary = {
  ...
  home: {
    ...
    featuredAction: 'View product',
    latestTitle: 'Top rated essentials',
    emptyState: 'No catalog products are available yet.',
  },
  products: {
    title: 'Shop all products',
    eyebrow: 'Products',
    description: 'Discover thoughtfully selected tech for work, home, and everyday life.',
  ...
  checkout: {
    title: 'Checkout',
    eyebrow: '',
    description: 'Review your selected products before placing your order.',
