...
export type GroupedChats = {
  today: AssistantHistoryItem[];
  yesterday: AssistantHistoryItem[];
  lastWeek: AssistantHistoryItem[];
  lastMonth: AssistantHistoryItem[];
  older: AssistantHistoryItem[];
};
 ...
 * ```
 */
export function groupChatsByDate(chats: AssistantHistoryItem[]): GroupedChats {
  const now = new Date();
