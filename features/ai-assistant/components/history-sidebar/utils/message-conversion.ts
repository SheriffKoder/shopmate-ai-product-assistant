 ...
 * ```
 */
export function convertMessageToUIMessage(message: AssistantMessageRecord): UIMessage {
  return {
    id: message.id,
 ...
 * ```
 */
export function convertMessagesToUIMessages(messages: AssistantMessageRecord[]): UIMessage[] {
